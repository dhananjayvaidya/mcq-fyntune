		...
		<div class='container'>
			<div class='row'>
				<div class='col-md-4 offset-md-4' >
					<div class='card'>
					<div class='card-body'>
						<form action="#" method="post" onsubmit="return GuestLogin()">
							<div class='form-group'>
								<label>Full Name</label>
								<input type="text" name='full_name' id='guest_full_name' placeholder="Enter your full name" class='form-control'/>
							</div>
							<div class='form-group'>
								<label>Email Address</label>
								<input type="email" name='email' id='guest_email' placeholder="Enter your email address" class='form-control' />
							</div>
							<div class='form-group'>
								<label>Phone Number</label>
								<input type='text' name='phone' id='guest_phone' placeholder="Enter your phone number" class='form-control' />
							</div>
							<div class='form-buttons'>
								<input type='submit' name='submit' value=' Start Test ' class='btn btn-raised btn-primary float-right'/>
							</div>
						</form>
					</div>
					</div>
